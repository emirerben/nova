...
### Fixed
- Creator requests using “text saying” retain the exact title and pastel-yellow styling, including planner/compiler fallbacks. Video-only, once-only montage confirmations respect available source duration.
