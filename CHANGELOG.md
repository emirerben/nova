...
- **Web CI no longer stalls on zero-delay user-event timers.** Interaction tests still dispatch the full browser event sequence, but no longer yield through timer hops that can freeze on hosted runners.
