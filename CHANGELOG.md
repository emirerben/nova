...
- **Background music and sound effects now share a voice-safe final mix.** Licensed tracks are selected deterministically, persisted for reburns, ducked under speech, and mixed with reveal effects without re-encoding the finished video stream.
