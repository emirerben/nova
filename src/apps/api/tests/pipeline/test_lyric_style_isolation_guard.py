...
range in `app/pipeline/lyric_injector.py` (lines 1218..1721, which covers
...
3. Recompute the new SHA:
     sed -n '1218,1721p' app/pipeline/lyric_injector.py | shasum -a 256
...
# post-pass. Line 1218 starts with `def _inject_line(`; line 1721 is the
...
_LINE_FROZEN_RANGE_START: int = 1218
_LINE_FROZEN_RANGE_END: int = 1721
