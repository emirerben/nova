"""Per-fixture eval gate for nova.video.landmark_guess (KRI-189).

Run modes (see tests/evals/README.md for full guide):
  pytest tests/evals/test_landmark_guess_evals.py -v
  pytest tests/evals/test_landmark_guess_evals.py -v --with-judge
"""
...
AGENT_DIR = "landmark_guess"
AGENT_NAME = "nova.video.landmark_guess"
...
def test_landmark_guess_eval(
    ...
    if fixture.meta.get("expect_empty"):
        assert output.get("name", "") == "", f"{result.fixture_id}: expected an unknown name"
