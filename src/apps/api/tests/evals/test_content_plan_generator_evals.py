"""Per-fixture eval gate for nova.plan.content_plan_generator.

Run modes (see tests/evals/README.md):
  pytest tests/evals/test_content_plan_generator_evals.py -v
  pytest tests/evals/test_content_plan_generator_evals.py -v --with-judge
...
AGENT_DIR = "content_plan_generator"
AGENT_NAME = "nova.plan.content_plan_generator"
...
def test_content_plan_generator_eval(
    fixture_path: Path,
    eval_mode: str,
    with_judge: bool,
    judge_for,
