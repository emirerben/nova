"""Per-fixture eval gate for nova.compose.overlay_placement (plan 009 E8).

Run modes (see tests/evals/README.md):
  pytest tests/evals/test_overlay_placement_evals.py -v
  pytest tests/evals/test_overlay_placement_evals.py -v --with-judge
  pytest tests/evals/test_overlay_placement_evals.py -v --eval-mode=live --with-judge

The LIVE run is a CI/hand-off gate — keyless dev machines run replay only.
"""
...
AGENT_DIR = "overlay_placement"
AGENT_NAME = "nova.compose.overlay_placement"
...
def test_overlay_placement_eval(
    fixture_path: Path,
    eval_mode: str,
    with_judge: bool,
    judge_for,
