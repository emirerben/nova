"""Per-fixture eval gate for nova.compose.platform_copy.

Run modes (see tests/evals/README.md for full guide):
  pytest tests/evals/test_platform_copy_evals.py -v
  pytest tests/evals/test_platform_copy_evals.py -v --with-judge
  pytest tests/evals/test_platform_copy_evals.py -v --eval-mode=live --with-judge
"""
...
AGENT_DIR = "platform_copy"
AGENT_NAME = "nova.compose.platform_copy"
