"""Per-fixture eval gate for nova.plan.persona_generator (persona_generator).

Run modes (see tests/evals/README.md):
  pytest tests/evals/test_persona_generator_evals.py -v
  pytest tests/evals/test_persona_generator_evals.py -v --with-judge
  pytest tests/evals/test_persona_generator_evals.py -v --eval-mode=live --with-judge
"""
...
AGENT_DIR = "persona_generator"
AGENT_NAME = "nova.plan.persona_generator"
...
def test_persona_generator_eval(
    fixture_path: Path,
    eval_mode: str,
    with_judge: bool,
    judge_for,
