"""Per-fixture eval gate for nova.compose.sequence_emphasis.
...
Run modes (see tests/evals/README.md):
  pytest tests/evals/test_sequence_emphasis_evals.py -v
  NOVA_EVAL_MODE=live pytest tests/evals/test_sequence_emphasis_evals.py -v --eval-mode=live

EVAL SKIA RULE: this file must NOT import skia or overlay_sizing at the top
level — eval CI lacks libEGL. intro_cluster (the role vocabulary source) is
import-light by design; nothing else overlay-related is needed here.
"""
...
AGENT_DIR = "sequence_emphasis"
AGENT_NAME = "nova.compose.sequence_emphasis"
...
def test_sequence_emphasis_eval(
    fixture_path: Path,
    eval_mode: str,
    with_judge: bool,
    judge_for,
