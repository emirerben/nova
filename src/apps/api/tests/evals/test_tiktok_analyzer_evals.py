"""Per-fixture eval gate for nova.plan.tiktok_analyzer.

Run modes (see tests/evals/README.md):
  pytest tests/evals/test_tiktok_analyzer_evals.py -v
  pytest tests/evals/test_tiktok_analyzer_evals.py -v --with-judge
  pytest tests/evals/test_tiktok_analyzer_evals.py -v --eval-mode=live --with-judge
"""
...
AGENT_DIR = "tiktok_analyzer"
AGENT_NAME = "nova.plan.tiktok_analyzer"
