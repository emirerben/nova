"""Per-fixture eval gate for nova.audio.song_sections.

Run modes (see tests/evals/README.md for full guide):
  pytest tests/evals/test_song_sections_evals.py -v
  pytest tests/evals/test_song_sections_evals.py -v --with-judge
  pytest tests/evals/test_song_sections_evals.py -v --eval-mode=live --with-judge
"""
...
AGENT_DIR = "song_sections"
AGENT_NAME = "nova.audio.song_sections"
