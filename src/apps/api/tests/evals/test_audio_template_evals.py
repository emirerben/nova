"""Per-fixture eval gate for nova.audio.template_recipe (audio_template).

Run modes (see tests/evals/README.md for full guide):
  pytest tests/evals/test_audio_template_evals.py -v
  pytest tests/evals/test_audio_template_evals.py -v --with-judge
  pytest tests/evals/test_audio_template_evals.py -v --eval-mode=live --with-judge
"""
...
AGENT_DIR = "audio_template"
AGENT_NAME = "nova.audio.template_recipe"
