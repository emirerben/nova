"""Per-fixture eval gate for nova.compose.overlay_format_matcher.

Run modes (see tests/evals/README.md):
  pytest tests/evals/test_overlay_format_matcher_evals.py -v
  pytest tests/evals/test_overlay_format_matcher_evals.py -v --with-judge
  pytest tests/evals/test_overlay_format_matcher_evals.py -v --eval-mode=live --with-judge
"""
...
AGENT_DIR = "overlay_format_matcher"
AGENT_NAME = "nova.compose.overlay_format_matcher"
...
def test_overlay_format_matcher_eval(
    fixture_path: Path,
    eval_mode: str,
    with_judge: bool,
    judge_for,
