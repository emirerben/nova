"""Per-fixture eval gate for nova.video.clip_metadata."""
...
def test_clip_metadata_eval(
    ...
    if fixture.agent != "nova.video.clip_metadata":
        pytest.skip(f"fixture is for {fixture.agent}, not clip_metadata")
