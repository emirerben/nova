"""Per-fixture eval gate for nova.plan.clip_plan_matcher (clip_plan_matcher).

Run modes (see tests/evals/README.md for full guide):
  pytest tests/evals/test_clip_plan_matcher_evals.py -v
  pytest tests/evals/test_clip_plan_matcher_evals.py -v --with-judge
  pytest tests/evals/test_clip_plan_matcher_evals.py -v --eval-mode=live --with-judge
"""
...
AGENT_DIR = "clip_plan_matcher"
AGENT_NAME = "nova.plan.clip_plan_matcher"
...
def test_clip_plan_matcher_eval(
    fixture_path: Path,
    eval_mode: str,
    with_judge: bool,
    judge_for,
