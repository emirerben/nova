"""Per-fixture eval gate for nova.plan.idea_expander.

Structural-only in CI (replay mode, no network): the recorded raw_text is
replayed through the agent parse path and the structural floor in
runners/structural.py.

Run modes (see tests/evals/README.md):
  pytest tests/evals/test_idea_expander_evals.py -v
  pytest tests/evals/test_idea_expander_evals.py -v --with-judge
  pytest tests/evals/test_idea_expander_evals.py -v --eval-mode=live --with-judge
"""
...
AGENT_DIR = "idea_expander"
AGENT_NAME = "nova.plan.idea_expander"
