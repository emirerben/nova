...
MediaCapability = Literal[
    ...
    # underlying plan lane before a recipe carrying them can exist. Kept in
    # lockstep with the Swift mirror (KriaMediaEngine.MediaCapability) by
    # tests/kria/test_capability_matrix.py.
    "captions",
    "customEffects",
    "mediaCards",
    "carouselEffects",
