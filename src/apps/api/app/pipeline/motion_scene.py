...
MOTION_RUNTIME_V5_HASH = "motion-v5:ck0.40.0:b2556106:2abfa191:creator-blocks-v4-capacity"
PREVIOUS_MOTION_RUNTIME_HASH = MOTION_RUNTIME_V5_HASH
MOTION_RUNTIME_HASH = "motion-v6:ck0.40.0:b2556106:2abfa191:creator-blocks-v5-text-appearance"
COMPATIBLE_MOTION_RUNTIME_HASHES = frozenset(
    {
        MOTION_RUNTIME_V2_HASH,
        MOTION_RUNTIME_V3_HASH,
        MOTION_RUNTIME_V4_HASH,
        MOTION_RUNTIME_V5_HASH,
        MOTION_RUNTIME_HASH,
    }
)
_TIMEOUT_S = 600
