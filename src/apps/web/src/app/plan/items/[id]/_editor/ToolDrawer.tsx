...
function CreatorBlockThumbnail({
  ...
  return (
    ...
    >
      <span className={previewReady ? "sr-only" : undefined}>{words[presetId]}</span>
      <CreatorBlockCatalogPreview
        instance={instance}
        assets={assets}
        ...
        <div className="mb-5 max-h-48 space-y-2 overflow-y-auto pr-1">
          {currentMusicTrackId && (
            <Button
              ...
              className="flex min-h-10 w-full items-center justify-center rounded-lg text-[12px] font-semibold text-[#71717a] hover:text-[#0c0c0e]"
            >
              Remove music
            </Button>
          )}
