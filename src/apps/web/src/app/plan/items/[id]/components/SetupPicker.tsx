...
export const STYLE_TILES: {
...
}[] = [
  {
    value: "classic",
    label: "Classic",
    desc: "Full-screen video cuts in sequence",
  ...
  },
  {
    value: "masonry",
    label: "Collage",
    desc: "Photos and videos arranged on a white wall",
  ...
  },
  {
    value: "polaroid_wall",
    label: "Photo wall",
    desc: "Photos arranged as oversized cards on a wall",
...
export default function SetupPicker({
  ...
  return (
    <div className="mb-4 space-y-2.5" data-testid="setup-picker">
      ...
      >
        <div
          className="scrollbar-none -mx-6 flex snap-x snap-mandatory gap-3.5 overflow-x-auto px-6 py-1 [scroll-padding-inline:1.5rem] sm:mx-0 sm:grid sm:grid-cols-2 sm:overflow-visible sm:p-0 lg:grid-cols-4"
          role="radiogroup"
          aria-label="Type"
