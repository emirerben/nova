          ...
          {items.map((item) => (
            ...
            >
              ...
              <button
                ...
                className="flex h-[28px] w-[28px] shrink-0 items-center justify-center rounded text-[#a1a1aa] opacity-0 transition-opacity hover:text-[#0c0c0e] group-hover:opacity-100"
              >
                ×
              </button>
            </li>
