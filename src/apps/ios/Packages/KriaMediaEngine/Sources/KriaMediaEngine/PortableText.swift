...
public struct PortableTextLayer: Codable, Equatable, Sendable {
    ...
    public func validate(duration: Double, manifest: RenderAssetManifest?) throws {
        ...
        if giantTitle != nil {
            guard [.static, .none, .fadeIn, .scaleUp, .slideUp, .slideDown, .slideIn, .popIn, .bounce, .inkReveal, .lyricLine, .typewriter, .streamIn, .karaokeLine, .smoothType].contains(effect) else { throw RecipeError.invalidTimeline }
        }
