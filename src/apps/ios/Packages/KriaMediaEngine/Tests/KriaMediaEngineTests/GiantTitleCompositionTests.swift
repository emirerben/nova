...
final class GiantTitleCompositionTests: XCTestCase {
    ...
    @MainActor func testGiantTitleUsesCompositionTimeAndSupportsBackwardSeekInPreviewAndExport() async throws {
        ...
        let exportCases = try rows.filter { ["static", "scheduled-typewriter", "late-karaoke", "smooth-motion", "staggered-late", "handwriting-legacy"].contains($0["id"] as? String ?? "") }.map { row in
