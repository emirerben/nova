...
- `EDIT_PROPOSAL_SEMANTIC_ENABLED` — defaults `false`; deploy migration 0107 and compiler v8 support to every API/worker before enabling new semantic drafts. Disabling stops new semantic drafts while approved v8 schedules remain readable and renderable; rollout: `docs/pipelines/guided-edit.md`.
