...
| Music bed | **Works, but broken fade** — see dedicated section below | `phone_montage_plan.py:262-305` emits the track; `Composition.swift` plays it flat-volume with no fade in/out. |
