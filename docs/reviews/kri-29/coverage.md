...
| `giant-title-wipe` | Native vector camera/opacity for static, none, fade-in, scale-up, slide-up/down/in, pop-in, bounce, ink-reveal, lyric-line, typewriter, stream-in, karaoke-line and smooth-type; 324 cloud frames plus preview/export/backward-seek tests pass | Handwriting, staggered and dissolve combinations; [physical pilot](giant-title.md) has successful exports with intermittent AVFoundation interruptions |
