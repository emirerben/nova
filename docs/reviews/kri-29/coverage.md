...
| Looks | `faded_analog`, `golden_hour`, `none`, `olive_film`, `smoky_split_tone`, `stadium_diffusion` (`pipeline/look_presets.py`) | Guided compiler only allows `none`. Golden-hour YUV/NV12 primitive matches all 393,216 production fixture bytes; recipe/compositor integration remains open ([details](color-looks.md)) |
