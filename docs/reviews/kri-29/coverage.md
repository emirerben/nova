...
| `giant-title-wipe` | Native vector camera/opacity for static, none, fade-in, scale-up, slide-up/down/in, pop-in, bounce, ink-reveal, lyric-line, typewriter and stream-in; 240 cloud frames plus preview/export/backward-seek tests pass | Handwriting, smooth reveal, staggered, karaoke and dissolve combinations; [physical pilot](giant-title.md) has successful exports with intermittent AVFoundation interruptions |
