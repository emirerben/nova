...
Its unfinished draft survives tab switches, and tapping the active tool
collapses the shell. The panel's visible grabber and the divider beneath the
...
boot already under way (PR #1183, guard
